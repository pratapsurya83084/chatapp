  ...
  return (
    <div className="flex items-center justify-center min-h-screen  p-4  ">
      <div className="w-full max-w-md  p-6 rounded border border-gray-400 ">
        ...
        <h2 className="text-lg font-semibold text-center text-gray-500 mt-2">Signup</h2>
        ...
        >
          ...
          <label className="input input-bordered flex items-center gap-2 p-3 border rounded-lg shadow-sm">
            ...
            <input type="text" className="grow outline-none" placeholder="fullname"  {...register("fullname", { required: true })}/>
          </label>
       ...
       <label className="input input-bordered flex items-center gap-2 p-3 border rounded-lg shadow-sm">
            ...
            <input type="password" className="grow outline-none" placeholder="Password" required/>
          </label>
          {/* Submit Button */}
